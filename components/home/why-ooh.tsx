            ...
            <div className="site-container">
                ...
                <div className="mx-auto grid max-w-[1144px] gap-5 lg:gap-[52px]">
                    {whyOoh.map((item, index) => (
                        <Reveal
                            key={item.keyword}
                            className="story-row card-base grid items-center gap-7 p-7 lg:h-[336px] lg:grid-cols-[340px_352px] lg:justify-center lg:gap-8 lg:p-0"
                            delay={0.05}
                            variant="card"
                        >
                            ...
                            <div
                                className={`grid h-[240px] w-full shrink-0 place-items-center lg:w-[352px] ${
